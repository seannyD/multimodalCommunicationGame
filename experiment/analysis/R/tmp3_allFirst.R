...
nTurnXmo = lmer(trialLength.log ~ 1 + 
                  numberOfTurns + numberOfTurns:modalityCondition +
                  (1 + condition + incorrect |dyadNumber/playerId) + 
                  (1 + modalityCondition|itemId),
                data=d, REML = FALSE)

nTurnXco = lmer(trialLength.log ~ 1 +  
                  numberOfTurns + numberOfTurns:modalityCondition +
...
tuXmoXco = lmer(trialLength.log ~ 1 +  
                  numberOfTurns + numberOfTurns:modalityCondition +
                  numberOfTurns:condition + 
                  numberOfTurns:condition:modalityCondition +
                  (1 + condition + incorrect |dyadNumber/playerId) + 
                  (1 + modalityCondition|itemId),
                data=d, REML = FALSE)
...
moXincor =   lmer(trialLength.log ~ 1 +  
                    numberOfTurns + numberOfTurns:modalityCondition +
                    numberOfTurns:condition + 
                    numberOfTurns:condition:modalityCondition +
...
coXincor =  lmer(trialLength.log ~ 1 + 
                   numberOfTurns + numberOfTurns:modalityCondition +
                   numberOfTurns:condition + 
                   numberOfTurns:condition:modalityCondition +
                   incorrect + (modalityCondition:incorrect) +
...
coXmoXin = lmer(trialLength.log ~ 1 + 
                  numberOfTurns + numberOfTurns:modalityCondition +
                  numberOfTurns:condition + 
                  numberOfTurns:condition:modalityCondition +
                  (incorrect + incorrect:condition + incorrect:modalityCondition)+
...
multiXco = lmer(trialLength.log ~ 1 + 
                  numberOfTurns + numberOfTurns:modalityCondition +
                  numberOfTurns:condition + 
                  numberOfTurns:condition:modalityCondition +
                  (incorrect + incorrect:condition + incorrect:modalityCondition)+
...
modXgamQ =  lmer(trialLength.log ~ 1 + 
                   trialTotal + I(trialTotal^2) +
                   numberOfTurns + numberOfTurns:modalityCondition +
                   numberOfTurns:condition + 
                   numberOfTurns:condition:modalityCondition +
...
modXgame = lmer(trialLength.log ~ 1 + modalityCondition*condition +
                  trialTotal + I(trialTotal^2) +
                  trialTotal:condition + trialTotal:modalityCondition +
                  numberOfTurns + numberOfTurns:modalityCondition +
                  numberOfTurns:condition + 
                  numberOfTurns:condition:modalityCondition +
                  (incorrect + incorrect:condition + incorrect:modalityCondition)+
